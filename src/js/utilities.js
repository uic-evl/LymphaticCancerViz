  ...
  App.Utilities = function () {
    ...
    function read_input_files(cb) {
        ...
        queue()
            ...
            .defer(d3.csv, "data/csv/clusters/06_06_2018/cluster_complete_bigrams_6_2018_k=5.csv")
            ...
            .defer(d3.csv, "data/csv/clusters/06_06_2018/cluster_weighted_bigrams_6_2018_k=5.csv")
